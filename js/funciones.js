...
funcionesPorPuesto["Puerta de ingreso Viru"] = `
  ...
  <h3>1. Objetivo del Puesto</h3>
  <p style="text-align: justify;">
    Describir las funciones y responsabilidades asignadas al vigilante que cumple tareas en el puesto de <strong>Puerta de ingreso Viru</strong>.
  </p>
...
funcionesPorPuesto["Puerta de ingreso LCL"] = `
  ...
  <h3>1. Objetivo del Puesto</h3>
  <p style="text-align: justify;">
    Describir las funciones y responsabilidades asignadas al vigilante que cumple tareas en el puesto de <strong>Puerta de ingreso LCL</strong>.
  </p>
  <!-- Más detalles según el puesto -->
`;
...
funcionesPorPuesto["Puerta de salida de camiones - Balanza de Salida"] = `
  ...
  <h3>1. Objetivo del Puesto</h3>
  <p style="text-align: justify;">
    Describir las funciones y responsabilidades asignadas al vigilante que cumple tareas en el puesto de <strong>Puerta de salida de camiones - Balanza de Salida</strong>.
  </p>
  <!-- Más detalles según el puesto -->
`;
